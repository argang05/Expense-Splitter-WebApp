        ...
        <>
          <div className="h-auto py-10 px-10 md:px-12 mt-20 w-min-full flex flex-col gap-6 items-center justify-center">
            ...
            <button
              ...
              className="orange-btn bxs border-[2px] border-[#000249] scale-out h-auto w-full py-4 md:py-8 cursor-pointer px-5 md:px-20 text-xl md:text-4xl font-semibold bg-[#F6490D] rounded-2xl"
            >
              Add Trip
            </button>
