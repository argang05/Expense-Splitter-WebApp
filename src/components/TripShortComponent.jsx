...
const TripShortComponent = ({trip}) => {
  return (
      <NavLink to={`/trip/${trip?.id}`}
          className='scale-out h-[auto] w-full py-4 px-5 bg-[#000249] border-[3px] border-[#03abff] text-white rounded-lg flex flex-col gap-4 items-start justify-center bxs'>
